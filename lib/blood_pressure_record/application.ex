defmodule BloodPressureRecord.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      BloodPressureRecordWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: BloodPressureRecord.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    BloodPressureRecordWeb.Endpoint.config_change(changed, removed)
    :ok
  end
