...
config :blood_pressure_record, BloodPressureRecordWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/blood_pressure_record_web/router\.ex$",
      ~r"lib/blood_pressure_record_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :blood_pressure_record, dev_routes: true
